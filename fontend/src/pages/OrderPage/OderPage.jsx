...
const OrderPage = () => {
    ...
    const itemsDelivery = [
        {
            title: '20.000VND',
            description: 'Dưới 200.000VND',
        },
        {
            title: '10.000VND',
            description: 'Từ 200.000VND dưới 500.000VND',
        },
        {
            title: '0VND',
        ...
        <div style={{ background: '#f5f5fa', width: '100%', height: '100vh' }}>
            <div style={{ height: '100%', width: '100%', margin: '0 auto' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <WrapperLeft>
                        <WrapperStyleHeader>
                            <StepsComponent items={itemsDelivery}
                                current={deliveryPrice === 10000 ? 1 : deliveryPrice === 20000 ? 0 : 2} />
                        </WrapperStyleHeader>
                        <WrapperStyleHeader>
                ...
                <div>
                    ...
                    >
                        ...
                        <Form.Item
                            label="Địa chỉ"
                            name="address"
                            rules={[{ required: true, message: 'Vui lòng nhập địa chỉ!' }]}
                        >
                        ...
                        <Form.Item
                            label="Thành phố"
                            name="city"
                            rules={[{ required: true, message: 'Vui lòng nhập thành phố!' }]}
                        >
                        ...
                        <Form.Item
                            ...
                            name="phone"
                            rules={[{ required: true, message: 'Nhập số điện thoại nhận hàng!' }]}
                        >
