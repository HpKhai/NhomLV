      ...
      >
        ...
        >
          ...
          <Form.Item
            label="Kinh Độ"
            name="x"
            rules={[{ required: true, message: "Nhập kinh độ (X) cửa hàng!" }]}
          >
            <InputComponents
              value={stateStore.x}
              onChange={handleOnChange}
          ...
          <Form.Item
            label="Vĩ Độ"
            name="y"
            rules={[{ required: true, message: "Nhập hoành độ (Y) cửa hàng!" }]}
          >
            <InputComponents
              value={stateStore.y}
              onChange={handleOnChange}
      ...
      >
        ...
        >
          ...
          <Form.Item
            label="Kinh Độ"
            name="x"
            rules={[{ required: true, message: "Nhập khinh độ (X) cửa hàng!" }]}
          >
            <InputComponents
