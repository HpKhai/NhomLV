...
const AdminUser = () => {
    ...
    const renderAction = () => {
        return (
            <div>
                ...
                <EditOutlined style={{ color: 'blue', fontSize: '16px', cursor: 'pointer', margin: '5px' }} onClick={handleDetailsUser} />
            </div>
        )
    }
    ...
    return (
        <div>
            ...
            <div>
                <Button style={{display:'none', height: '50px', width: '50px', color: 'blue', backgroundColor: 'white', margin: '10px' }}
                    onClick={() => setIsModalOpen(true)}><PlusOutlined /></Button>
            </div>
            <div>
                <TableComponent handleDeleteMany={handleDeleteManyUser} columns={columns} data={dataTable} onRow={(record) => {
                    return {
                        onClick: event => {
            ...
            <DrawerComponent title='Chi tiết người dùng' isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)} width='75%' >
                <Form
                    name="basic"
                    labelCol={{ span: 4 }}
                    wrapperCol={{ span: 20 }}
                ...
                >
                    ...
                    >
                        <InputComponents disabled value={stateUserDetails.name} onChange={handleOnChangeDetails} name="name" />
                    </Form.Item>
            ...
            <ModalComponent forceRender title="Xóa người dùng" open={isModalOpenDelete} onCancel={handleCancelDelete} onOk={handleDeleteUser} >
                <div>
