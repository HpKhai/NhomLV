        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input count inStock product!",
              },
            ]}
          >
            <InputComponents
          ...
          <Form.Item
            ...
            name="discount"
            rules={[
              { required: false, message: "Please input discount of product!" },
            ]}
          >
            <InputComponents
          ...
          <Form.Item
            ...
            name="origin"
            rules={[
              { required: true, message: "Please input origin of product!" },
            ]}
          >
            <InputComponents
          ...
          <Form.Item
            ...
            name="uses"
            rules={[
              { required: true, message: "Please input uses of product!" },
            ]}
          >
            <InputComponents
          ...
          <Form.Item
            ...
            name="report"
            rules={[
              { required: true, message: "Please input report product!" },
            ]}
          >
            <InputComponents
